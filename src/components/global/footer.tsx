    ...
    <footer className="relative border-t border-white/[0.04]" style={{ background: "#06060A" }}>
      <div className="max-w-[1400px] mx-auto px-10 py-20 lg:px-12">
        ...
        <div className="mb-16">
          ...
          <motion.a
            to="mailto:vitspotcheck@vit.ac.in"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mb-20">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <motion.a
                to="https://github.com/devxnshsharma/VITspotCheck"
                target="_blank"
                rel="noopener"
              ...
              <motion.a
                to="https://www.linkedin.com/school/vellore-institute-of-technology/"
                target="_blank"
                rel="noopener"
                className="text-white/45 text-sm"
                whileHover={{ color: "#FBBF24", x: 3 }}
              ...
              <motion.a
                to="https://www.instagram.com/vellore_vit/"
                target="_blank"
                rel="noopener"
                className="text-white/45 text-sm"
                whileHover={{ color: "#FBBF24", x: 3 }}
